...
public class HomeController {
  ...
  private void initializeCustomerTable() {
    ...
    Platform.runLater(
        () -> {
          this.setTableColumnWidths(this.customerTableView);
        });
  }
  ...
  private void initializeAppointmentTable() {
    ...
    Platform.runLater(
        () -> {
          this.setTableColumnWidths(this.appointmentTableView);
        });
  }

  /**
   * Sets a TableView's columns' widths dynamically for better display on the page.
   * @param table
   */
  private void setTableColumnWidths(TableView<?> table) {
