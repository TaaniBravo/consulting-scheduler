...
public class SuccessMessages {
  ...
  public static final String APPOINTMENT_ADDED = resources.getString("success.appointment.add");
  public static final String APPOINTMENT_UPDATED = resources.getString("success.appointment.update");
}
