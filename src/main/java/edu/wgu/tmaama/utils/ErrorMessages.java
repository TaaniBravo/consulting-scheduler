...
public class ErrorMessages {
	...
	public static final String DELETE_CUSTOMER_ERROR = resources.getString("error.customer.delete");
	public static final String DELETE_APPOINTMENT_ERROR = resources.getString("error.appointment.delete");
}
